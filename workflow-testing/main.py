...
def draft_response(state: EmailState):
    responses = {
        "urgent": "Thank you for your email. We will get back to you as soon as possible.",
        "normal": "Thank you for your email. We will get back to you soon.",
        "spam": "Go away!"
    }
...
result = graph.invoke({"email": "Hello, I need help with my account. It's urgent."})
