...
clarity_agent = Agent(
    ...
    output_key="clarity_output",model=MODEL
)
...
tone_stylist_agent = Agent(
    ...
    output_key="tone_output",model=MODEL
)
...
persuation_agent = Agent(
    ...
    output_key="persuasion_output",model=MODEL
)
...
email_synthesizer_agent = Agent(
    ...
    output_key="synthesized_output", model=MODEL
)

def escalate_email_complete(tool_context):
